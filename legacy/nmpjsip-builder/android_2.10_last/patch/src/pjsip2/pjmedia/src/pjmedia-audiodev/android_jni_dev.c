                                         ...
                                         pjmedia_aud_stream **p_aud_strm)
{
	    ...
	    (param->input_route & PJMEDIA_AUD_DEV_ROUTE_CUSTOM))
	{
	    ...
	    char sdk_version[PROP_VALUE_MAX];
            ...
            if (sdk_v > 10)
            */
            mic_source = 7; /* VOICE_COMMUNICATION */ // Standart. Tested: Android 7 Working
            //A//
    ...
    if (stream->dir & PJMEDIA_DIR_PLAYBACK) {
        ...
        track_obj = (*jni_env)->NewObject(jni_env,
                                          ...
                                          constructor_method,
                                          //A//
                                          // 0, /* STREAM_VOICE_CALL */ //Android 7 not working, Android 9 (redmi) OK
                                          // 3, /* 3 - STREAM_MUSIC */ //Android 7 OK (не совсем, без звонка - в динамик, а не в гарнитуру)
                                          1, /* 1 - STREAM_SYSTEM */ //Checkink                                          
                                          param->clock_rate,
                                          channelOutCfg,
                                          sampleFormat,
                                          inputBuffSizePlay,
