...
export NDK=/sources/android_ndk

#export NDK=[your_android_ndk_path]/android-ndk-r17b

#$NDK/build/tools/make-standalone-toolchain.sh --platform=android-19 --toolchain=aarch64-linux-android-4.9 --install-dir=/android-toolchain-arm64
