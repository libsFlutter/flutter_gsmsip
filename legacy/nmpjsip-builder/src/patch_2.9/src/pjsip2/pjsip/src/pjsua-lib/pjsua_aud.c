...
#undef update_param
    ...
    //A//
    param->headphones_only=pjsua_var.media_cfg.headphones_only;
    param->mic_source=pjsua_var.media_cfg.mic_source;
    param->stream_type=pjsua_var.media_cfg.stream_type;
    param->adjust_tx=pjsua_var.media_cfg.adjust_tx;
    param->adjust_rx=pjsua_var.media_cfg.adjust_rx;
