                                        ...
                                        pjmedia_aud_stream **p_aud_strm)
{
    ...
    if (stream->dir & PJMEDIA_DIR_PLAYBACK) {
        ...
        */
        ...
        //A//
        //stream->playerBufferSize = bufferSize*2;
    ...
    if (stream->dir & PJMEDIA_DIR_CAPTURE) {
        ...
        https://android.googlesource.com/platform/frameworks/wilhelm/+/master/include/SLES/OpenSLES_Android.h
