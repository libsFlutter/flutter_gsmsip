...
//A//
//#if defined(PJMEDIA_A_R) && PJMEDIA_A_R!=0
...
//A//	    pjmedia_convert_channel_rnto1((pj_int16_t*)f.buf, 
						 (const pj_int16_t*)f.buf,
						 cport->channel_count, 
						 cport->samples_per_frame, 
...
//#if defined(PJMEDIA_A_R) && PJMEDIA_A_R!=0
//A// 	    pjmedia_convert_channel_r1ton(tx_buf, tx_buf,
//#else
...
//#endif
	    ...
	    //A//pjmedia_convert_channel_rnto1(tx_buf, tx_buf,
					 conf->channel_count, 
