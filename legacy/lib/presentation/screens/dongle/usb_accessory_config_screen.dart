...
/// Экран конфигурации USB Audio Accessory донгла
class UsbAccessoryConfigScreen extends StatefulWidget {
  const UsbAccessoryConfigScreen({super.key});

  @override
  State<UsbAccessoryConfigScreen> createState() => _UsbAccessoryConfigScreenState();
}

class _UsbAccessoryConfigScreenState extends State<UsbAccessoryConfigScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('USB Audio Accessory'),
        actions: [
          IconButton(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              initialValue: 'USB Audio Accessory',
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildStatusRow('Mode', 'Audio Accessory (Analog)'),
            _buildStatusRow(
              'Status',
          ...
          children: [
            ...
            Container(
              ...
              child: const Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Adapter: 4R+1C Differential Circuit'),
                  SizedBox(height: 4),
                  Text('Output: RJ11 Phone Line'),
                ],
              ),
            ),
          ],
